...
[![build](https://img.shields.io/github/actions/workflow/status/mevacoin/mevacoin/master-ci.yml?branch=master)](https://github.com/mevacoin/mevacoin/actions/workflows/master-ci.yml)
[![release](https://img.shields.io/github/v/release/mevacoin/mevacoin)](https://img.shields.io/github/v/release/mevacoin/mevacoin)
...
Kryptokrona is a decentralized blockchain from the Nordic based on MevaCoin, which forms the basis for Monero, among others. MevaCoin is a so-called “application layer” protocol further developed by TurtleCoin that enables things like: private transactions, messages and arbitrary data storage, completely decentralized.
...
- Web: mevacoin.org
- Docs: https://docs.mevacoin.org
- GitHub: https://github.com/mevacoin
...
- Twitter: https://twitter.com/mevacoin

## Getting Help

Are you having trouble with Kryptokrona? We want to help!

- Read through all documentation on our Wiki: https://docs.mevacoin.org

- If you are upgrading, read the release notes for upgrade instructions and "new and noteworthy" features.

- Ask a question we monitor stackoverflow.com for questions tagged with mevacoin. You can also chat with the community on Hugin or Discord.

- Report bugs with Kryptokrona at https://github.com/mevacoin/mevacoin/issues.
...
We offer binary images of the latest releases here: https://github.com/mevacoin/mevacoin/releases
...
- `export CC=gcc-11`
- `export CXX=g++-11`
- `git clone -b master --single-branch https://github.com/mevacoin/mevacoin`
- `cd mevacoin`
- `mkdir build`
- `cd build`
- `cmake ..`
...
- `MSBuild mevacoin.sln /p:Configuration=Release /p:PlatformToolset=v141`

The binaries will be in the `src/Release` folder when you are complete.

- `cd src`
- `cd Release`
- `mevacoin.exe --version`
...
Check also out the article made by Marcus Cvjeticanin here: https://medium.com/coinsbench/setup-a-testnet-with-mevacoin-blockchain-41b5f9ffd86

## Deploy node

To deploy your own node, please follow the instructions on our Wiki: [https://docs.mevacoin.org/guides/mevacoin/deploy-your-own-full-node](https://docs.mevacoin.org/guides/mevacoin/deploy-your-own-full-node)
...
MEVACOIN Developers, Bytecoin Developers, Monero Developers, Forknote Project, TurtleCoin Community, Kryptokrona Developers

## Copypasta for license when editing files

Hi Kryptokrona contributor, thanks for forking and sending back Pull Requests. Extensive docs about contributing are in the works or elsewhere. For now this is the bit we need to get into all the files we touch. Please add it to the top of the files, see [src/mevacoin_config.h](https://github.com/turtlecoin/turtlecoin/commit/28cfef2575f2d767f6e512f2a4017adbf44e610e) for an example.
...
[<img src="https://github.com/kurosci.png?size=72" alt="kurosci" width="72">](https://github.com/kurosci)
