...
namespace miner
{
    ...
    void MinerManager::startMining(const mevacoin::BlockMiningParameters &params)
    {
    ...
    void MinerManager::adjustBlockTemplate(mevacoin::BlockTemplate &blockTemplate) const
    {
