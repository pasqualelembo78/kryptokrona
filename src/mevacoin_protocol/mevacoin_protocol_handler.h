...
#include "mevacoin_core/icore.h"

#include "mevacoin_protocol/mevacoin_protocol_definitions.h"
#include "mevacoin_protocol/mevacoin_protocol_handler_common.h"
#include "mevacoin_protocol/imevacoin_protocol_observer.h"
#include "mevacoin_protocol/imevacoin_protocol_query.h"
...
namespace mevacoin
{
    ...
    class MevaCoinProtocolHandler : public IMevaCoinProtocolHandler
    {
    public:
        MevaCoinProtocolHandler(const Currency &currency, syst::Dispatcher &dispatcher, ICore &rcore, IP2pEndpoint *p_net_layout, std::shared_ptr<logging::ILogger> log);
    ...
    private:
        ...
        int processObjects(MevaCoinConnectionContext &context, std::vector<RawBlock> &&rawBlocks, const std::vector<CachedBlock> &cachedBlocks);
