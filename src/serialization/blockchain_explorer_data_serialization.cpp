...
namespace mevacoin
{
    ...
    using mevacoin::SerializationTag;
    ...
    namespace
    {
        ...
        void getVariantValue(mevacoin::ISerializer &serializer, uint8_t tag, boost::variant<mevacoin::BaseInputDetails, mevacoin::KeyInputDetails> &in)
        {
