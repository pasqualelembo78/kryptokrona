...
namespace mevacoin
{
    ...
    void JsonRpcServer::processRequest(const mevacoin::HttpRequest &req, mevacoin::HttpResponse &resp)
    {
        try
        {
            ...
            else
            {
                ...
                resp.setStatus(mevacoin::HttpResponse::STATUS_404);
                return;
            }
        }
        catch (std::exception &e)
        {
            ...
            resp.setStatus(mevacoin::HttpResponse::STATUS_500);
        }
    }
    ...
    void JsonRpcServer::makeErrorResponse(const std::error_code &ec, common::JsonValue &resp)
    {
        ...
        JsonValue code;
        code = static_cast<int64_t>(mevacoin::json_rpc::errParseError); // Application specific error code
    ...
    void JsonRpcServer::makeMethodNotFoundResponse(common::JsonValue &resp)
    {
        ...
        JsonValue code;
        code = static_cast<int64_t>(mevacoin::json_rpc::errMethodNotFound); // ambigous declaration of JsonValue::operator= (between int and JsonValue)
    ...
    void JsonRpcServer::makeInvalidPasswordResponse(common::JsonValue &resp)
    {
        ...
        JsonValue code;
        code = static_cast<int64_t>(mevacoin::json_rpc::errInvalidPassword);
    ...
    void JsonRpcServer::makeJsonParsingErrorResponse(common::JsonValue &resp)
    {
        ...
        JsonValue error(JsonValue::OBJECT);
        JsonValue code;
        code = static_cast<int64_t>(mevacoin::json_rpc::errParseError); // ambigous declaration of JsonValue::operator= (between int and JsonValue)
