...
namespace wallet_config
{
    ...
    /* The name of service/walletd, the programmatic rpc interface to a
       wallet */
    const std::string walletdName = "mevacoind-service";

    /* The full name of your crypto */
    const std::string coinName = std::string(mevacoin::MEVACOIN_NAME);

    /* Where can your users contact you for support? E.g. discord */
    const std::string contactLink = "https://mevacoin.it";
    ...
    /* If a mixin of zero is disabled, at what height was it disabled? E.g.
       ...
       zero is allowed */
    const uint64_t mixinZeroDisabledHeight = mevacoin::parameters::MIXIN_LIMITS_V2_HEIGHT;
