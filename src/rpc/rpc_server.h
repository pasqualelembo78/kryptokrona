...
namespace mevacoin
{
    ...
    class Core;
    class NodeServer;
    struct IMevaCoinProtocolHandler;

    class RpcServer : public HttpServer
    {
    public:
        RpcServer(syst::Dispatcher &dispatcher, std::shared_ptr<logging::ILogger> log, Core &c, NodeServer &p2p, IMevaCoinProtocolHandler &protocol);
    ...
    private:
        ...
        Core &m_core;
        NodeServer &m_p2p;
        IMevaCoinProtocolHandler &m_protocol;
