...
namespace payment_service
{
    ...
    private:
        ...
        void SerializeRequest(RequestType &request, mevacoin::JsonInputValueSerializer &inputSerializer)
        {
            serialize(request, inputSerializer);
        }

        void SerializeRequest(SendTransaction::Request &request, mevacoin::JsonInputValueSerializer &inputSerializer)
        {
            request.serialize(inputSerializer, service);
        }

        void SerializeRequest(CreateDelayedTransaction::Request &request, mevacoin::JsonInputValueSerializer &inputSerializer)
        {
            request.serialize(inputSerializer, service);
        }

        void SerializeRequest(SendFusionTransaction::Request &request, mevacoin::JsonInputValueSerializer &inputSerializer)
        {
            request.serialize(inputSerializer, service);
        }
