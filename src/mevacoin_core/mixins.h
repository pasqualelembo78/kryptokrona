...
namespace mevacoin
{
    ...
    public:
        ...
        static std::tuple<uint64_t, uint64_t, uint64_t> getMixinAllowableRange(const uint64_t height)
        {
            ...
            uint64_t defaultMixin = mevacoin::parameters::DEFAULT_MIXIN_V0;
            ...
            if (height >= mevacoin::parameters::MIXIN_LIMITS_V4_HEIGHT)
            {
                minMixin = mevacoin::parameters::MINIMUM_MIXIN_V4;
                maxMixin = mevacoin::parameters::MAXIMUM_MIXIN_V4;
                defaultMixin = mevacoin::parameters::DEFAULT_MIXIN_V4;
            }
            else if (height >= mevacoin::parameters::MIXIN_LIMITS_V3_HEIGHT)
            {
                minMixin = mevacoin::parameters::MINIMUM_MIXIN_V3;
                maxMixin = mevacoin::parameters::MAXIMUM_MIXIN_V3;
                defaultMixin = mevacoin::parameters::DEFAULT_MIXIN_V3;
            }
            else if (height >= mevacoin::parameters::MIXIN_LIMITS_V2_HEIGHT)
            {
                minMixin = mevacoin::parameters::MINIMUM_MIXIN_V2;
                maxMixin = mevacoin::parameters::MAXIMUM_MIXIN_V2;
                defaultMixin = mevacoin::parameters::DEFAULT_MIXIN_V2;
            }
            else if (height >= mevacoin::parameters::MIXIN_LIMITS_V1_HEIGHT)
            {
                minMixin = mevacoin::parameters::MINIMUM_MIXIN_V1;
                maxMixin = mevacoin::parameters::MAXIMUM_MIXIN_V1;
                defaultMixin = mevacoin::parameters::DEFAULT_MIXIN_V1;
            }
        ...
        static std::tuple<bool, std::string, std::error_code> validate(const uint64_t mixin, const uint64_t height)
        {
            ...
            if (mixin < minMixin)
            {
                ...
                return {false, str.str(), make_error_code(mevacoin::error::MIXIN_BELOW_THRESHOLD)};
            }
            else if (mixin > maxMixin)
            {
                str << "Mixin of " << mixin << " above maximum mixin threshold of " << maxMixin;
                return {false, str.str(), make_error_code(mevacoin::error::MIXIN_ABOVE_THRESHOLD)};
            }
