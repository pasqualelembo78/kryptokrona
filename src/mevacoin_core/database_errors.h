...
inline std::error_code make_error_code(mevacoin::error::DataBaseErrorCodes e)
{
    return std::error_code(static_cast<int>(e), mevacoin::error::DataBaseErrorCategory::INSTANCE);
}
