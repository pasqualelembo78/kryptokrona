...
namespace mevacoin
{
    namespace error
    {
        ...
        inline std::error_code make_error_code(mevacoin::error::TransactionValidationError e)
        {
            return std::error_code(static_cast<int>(e), mevacoin::error::TransactionValidationErrorCategory::INSTANCE);
        }
...
namespace std
{
    ...
    template <>
    struct is_error_code_enum<mevacoin::error::TransactionValidationError> : public true_type
    {
    };
