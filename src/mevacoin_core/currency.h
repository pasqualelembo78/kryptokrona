...
namespace mevacoin
{
    ...
    public:
        ...
        {
            if (blockHeight >= mevacoin::parameters::LWMA_2_DIFFICULTY_BLOCK_INDEX_V3)
            {
                return mevacoin::parameters::BLOCKCHAIN_TIMESTAMP_CHECK_WINDOW_V3;
            }
            else
            {
        ...
        {
            if (blockHeight >= mevacoin::parameters::LWMA_2_DIFFICULTY_BLOCK_INDEX_V2)
            {
                return mevacoin::parameters::MEVACOIN_BLOCK_FUTURE_TIME_LIMIT_V4;
            }
            else if (blockHeight >= mevacoin::parameters::LWMA_2_DIFFICULTY_BLOCK_INDEX)
            {
                return mevacoin::parameters::MEVACOIN_BLOCK_FUTURE_TIME_LIMIT_V3;
            }
            else
            {
        ...
        {
            if (height >= mevacoin::parameters::DUST_THRESHOLD_V2_HEIGHT)
            {
                return mevacoin::parameters::DEFAULT_DUST_THRESHOLD_V2;
            }
        ...
        {
            if (height >= mevacoin::parameters::FUSION_DUST_THRESHOLD_HEIGHT_V2)
            {
                return mevacoin::parameters::DEFAULT_DUST_THRESHOLD_V2;
            }
