...
{
    uint64_t T = mevacoin::parameters::DIFFICULTY_TARGET;
    uint64_t N = mevacoin::parameters::DIFFICULTY_WINDOW_V3;
    ...
    if (timestamps.size() < mevacoin::parameters::DIFFICULTY_BLOCKS_COUNT_V3)
    {
        N = timestamps.size() - 1;
    }
...
{
    int64_t T = mevacoin::parameters::DIFFICULTY_TARGET;
    int64_t N = mevacoin::parameters::DIFFICULTY_WINDOW_V3;
...
uint64_t nextDifficultyV3(std::vector<uint64_t> timestamps, std::vector<uint64_t> cumulativeDifficulties)
{
    int64_t T = mevacoin::parameters::DIFFICULTY_TARGET;
    int64_t N = mevacoin::parameters::DIFFICULTY_WINDOW_V3;
    int64_t FTL = mevacoin::parameters::MEVACOIN_BLOCK_FUTURE_TIME_LIMIT_V3;
    int64_t L(0), ST, sum_3_ST(0), next_D, prev_D;
