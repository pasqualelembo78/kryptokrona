                              ...
                              uint64_t &reward, int64_t &emissionChange) const
{
    ...
    {
        /* nextDifficultyV3 and above are defined in src/MevaCoinCore/Difficulty.cpp */
...
m_tailEmissionReward(parameters::FINAL_SUBSIDY),
