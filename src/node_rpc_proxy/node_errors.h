...
inline std::error_code make_error_code(mevacoin::NodeError::NodeErrorCodes e)
{
    return std::error_code(static_cast<int>(e), mevacoin::NodeError::NodeErrorCategory::INSTANCE);
}
