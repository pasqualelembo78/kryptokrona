...
namespace mevacoin
{
    ...
    std::error_code NodeRpcProxy::doGetGlobalIndexesForRange(
        ...
        std::unordered_map<crypto::Hash, std::vector<uint64_t>> &indexes)
    {
        mevacoin::COMMAND_RPC_GET_GLOBAL_INDEXES_FOR_RANGE::request req = AUTO_VAL_INIT(req);
        mevacoin::COMMAND_RPC_GET_GLOBAL_INDEXES_FOR_RANGE::response rsp = AUTO_VAL_INIT(rsp);
    ...
    std::error_code NodeRpcProxy::doGetTransactionsStatus(
        ...
        std::unordered_set<crypto::Hash> &transactionsUnknown)
    {
        mevacoin::COMMAND_RPC_GET_TRANSACTIONS_STATUS::request req = AUTO_VAL_INIT(req);
        mevacoin::COMMAND_RPC_GET_TRANSACTIONS_STATUS::response rsp = AUTO_VAL_INIT(rsp);
    ...
    std::error_code NodeRpcProxy::doGetWalletSyncData(const std::vector<crypto::Hash> &knownBlockIds, uint64_t startHeight, uint64_t startTimestamp, std::vector<wallet_types::WalletBlockInfo> &newBlocks)
    {
        ...
        mevacoin::COMMAND_RPC_GET_WALLET_SYNC_DATA::request req = AUTO_VAL_INIT(req);
        mevacoin::COMMAND_RPC_GET_WALLET_SYNC_DATA::response rsp = AUTO_VAL_INIT(rsp);
