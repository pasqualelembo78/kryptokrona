...
namespace mevacoin
{
    ...
    public:
        ...
        P2pConnectionContext(P2pConnectionContext &&ctx) : MevaCoinConnectionContext(std::move(ctx)),
                                                           context(ctx.context),
                                                           peerId(ctx.peerId),
    ...
    {
    public:
        NodeServer(syst::Dispatcher &dispatcher, mevacoin::MevaCoinProtocolHandler &payload_handler, std::shared_ptr<logging::ILogger> log);
    ...
    private:
        ...
        virtual bool invoke_notify_to_peer(int command, const BinaryArray &req_buff, const MevaCoinConnectionContext &context) override;
        virtual void for_each_connection(std::function<void(mevacoin::MevaCoinConnectionContext &, uint64_t)> f) override;
        ...
        bool idle_worker();
        bool handle_remote_peerlist(const std::list<PeerlistEntry> &peerlist, time_t local_time, const MevaCoinConnectionContext &context);
